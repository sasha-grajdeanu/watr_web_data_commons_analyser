...
from services.classification.classification_statistics_graph_service import classification_statistics_graph_service

classificationStatsGraph = Blueprint('classificationStatsGraph', __name__)
...
def classification_statistics_graph_controller():
    ...
    results = classification_statistics_graph_service(rdf_class, rdf_property)
    return results
